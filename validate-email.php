                ...
                <div class="index-intro-2">
                    <div class="registration">
                        ...
                        <form id="formID" class="formular" action="signup-photo" method="POST">
                            <ul>
                                <li>
                                    <label for="email">An email verification link has been sent to the email address you provided earlier, you need to click on this 
                                    link to verify you email. Please note that you may not use gossout until you verify you email.</label>

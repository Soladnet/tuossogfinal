...
if ($type == 'xml') {
    ...
    if (isset($_FILES['myfile'])) {
        ...
        if ((($_FILES["myfile"]["type"] == "image/gif") || ($_FILES["myfile"]["type"] == "image/jpeg") || ($_FILES["myfile"]["type"] == "image/png") || ($_FILES["myfile"]["type"] == "image/pjpeg")) && ($data['size'] < 5120 && $data['size'] > 5) && in_array($data['extension'], $allowedExts) && !($_FILES["myfile"]["error"] > 0)) {

        ...
        <div class="index-page-wrapper">	
            ...
            <div class="index-intro">
                <div class="index-intro-1">
                    ...
                    <input class="main-search" type="text" <?php echo isset($_GET['g']) ? "value='" . $_GET['g'] . "'" : 'placeholder="Search term here"' ?>>
                    <span><center><input class="button-big" type="submit" name="g" value="Search" /> <!--<button class="button-big"><a href="">Sign up</a></button>--></center></span>
                    <div class="clear"></div>
